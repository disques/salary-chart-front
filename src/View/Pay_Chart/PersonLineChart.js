...
const indexBy = "id";
const data = [
  { [indexBy]: "2021.12.01" , 누적근로자: 4000, 최근30일근로자: 3000, 최근45일1회이상수신: 1000, 최근45일1회이상수신X: 1300 },
  { [indexBy]: "2021.12.02", 누적근로자: 4000, 최근30일근로자: 3000, 최근45일1회이상수신: 1500, 최근45일1회이상수신X: 1300 },
  { [indexBy]: "2021.12.03", 누적근로자: 4000, 최근30일근로자: 2000, 최근45일1회이상수신: 1500, 최근45일1회이상수신X: 1300 },
  { [indexBy]: "2021.12.04", 누적근로자: 4000, 최근30일근로자: 5000, 최근45일1회이상수신: 1500, 최근45일1회이상수신X: 1300 },
  { [indexBy]: "2021.12.05" , 누적근로자: 4000, 최근30일근로자: 3000, 최근45일1회이상수신: 1500, 최근45일1회이상수신X: 1300 },
];
