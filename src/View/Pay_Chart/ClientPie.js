...
export default function ClientPie(props) {
...
const CenteredMetricClient = ({ dataWithArc, centerX, centerY }) => {
  return (
    ...
    >
      <tspan x="240" dy="-0.6em" fill="#474747">총이용회사</tspan>
  ...
  return (
    <Box mt={10} width="400px" height="400px">
      <Box display="flex" justifyContent="center">
        <LabelItem color="#e8c1a0" decsTitle="전체계정" data1="20" data2="10"/>
        <LabelItem color="#f47560" decsTitle="활성화계정" data1="20" data2="10"/>
      </Box>
      <Box mt={5}>
        <LabelItem color="#f1e15b" decsTitle="비활성화계정" data1="20" data2="10"/>
      </Box>
      <Box mt={4} align="left">
